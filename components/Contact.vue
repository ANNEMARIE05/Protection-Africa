          ...
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              ...
              <p class="text-base leading-relaxed text-body-color dark:text-dark-6 mb-9">
                Voici quelques numéros de téléphone importants qui peuvent vous être utiles, également utiliser le formulaire de contact ci-dessous.
              </p>
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="mb-1 text-xl font-bold text-dark dark:text-white">Notre localisation</h4>
                  <p class="text-base text-body-color dark:text-dark-6">
                    Côte d'ivoire (CI) Abidjan Koumassi
                  </p>
                </div>
              </div>
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="mb-1 text-xl font-bold text-dark dark:text-white">Notre telephone</h4>
                  <p class="text-base text-body-color dark:text-dark-6">(+225) 01 72 31 79 83</p>
                </div>
              </div>
              <div class="mb-8 flex w-full max-w-[370px]">
                <div
                ...
                <div class="w-full">
                  <h4 class="mb-1 text-xl font-bold text-dark dark:text-white">Adresse Email</h4>
                  <p class="text-base text-body-color dark:text-dark-6">vague.digital@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
