...
const menus = ref([
  {
    title: 'Services',
    items: [
      { text: 'Developpement', link: 'javascript:void(0)' },
      { text: 'Reseaux et securité informatique', link: 'javascript:void(0)' },
      { text: 'Graphisme', link: 'javascript:void(0)' },
      { text: 'Autres', link: 'javascript:void(0)' }
    ]
  },
  {
    title: 'Outils',
    items: [
      { text: 'Teams', link: 'javascript:void(0)' },
      { text: 'Notion', link: 'javascript:void(0)' },
      { text: 'Meet', link: 'javascript:void(0)' },
      { text: 'Email', link: 'javascript:void(0)' }
    ]
  },
  {
    title: 'Autres liens',
    items: [
      { text: 'Accueil', link: 'javascript:void(0)' },
      { text: 'A propos', link: 'javascript:void(0)' },
      { text: 'Blog', link: 'javascript:void(0)' },
      { text: 'Contacts', link: 'javascript:void(0)' }
    ]
  }
])
</script>
      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div class="w-full mb-10">
            <h1 class="text-2xl font-bold text-indigo-600 sm:text-2xl">Protect_Africa</h1>

            <p>
              Votre application qui vous garantis la securité partout ou vous êtes et a tous moment.
            </p>
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
          <div class="w-full mb-10">
            <h4 class="text-lg font-semibold text-dark dark:text-white mb-9">Réseaux sociaux</h4>
            ...
            <p class="text-base text-body-color dark:text-dark-6">&copy; 2024 Protect Africa</p>
          </div>
        </div>
      </div>
    </div>
